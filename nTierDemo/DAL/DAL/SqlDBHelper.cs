...
namespace DAL
{
    class SqlDBHelper
    {
        //const string CONNECTION_STRING = @"Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\NORTHWND.MDF;Trusted_Connection=Yes;";
        const string CONNECTION_STRING = @"Data Source=LENOVO\SQLEXPRESS;Initial Catalog=C:\RAHULSINGH\TESTPROJECTS\NTIERDEMO\PL\APP_DATA\NORTHWND.MDF;Persist Security Info=True;User ID=sa;Password=jojo";
